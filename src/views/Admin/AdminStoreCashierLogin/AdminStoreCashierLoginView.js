...
const AdminStoreCashierLoginView = props => {
                ...
                <Column md={8} sm={12}>
                    <div className="admin-login__content">
                        <div className="admin-login__heading">
                            ...
                            <h6 className="heading-subtitle">Silahkan masukkan username <i><b>Kasir</b></i> dan password untuk masuk.</h6>
                        </div>
...
export default AdminStoreCashierLoginView;
