    ...
    constructor(props) {
        ...
        this.state = {
            routes: [
                        ...
                        { id : 1, name: 'topup', path: `${props.match.url}/topup-saldo`, component: StoreCashierTopUp },
                        { id : 2, name: 'kartubaru', path: `${props.match.url}/kartu-baru`, component: StoreCashierNewCard },
                        { id : 3, name: 'refundkartu', path: `${props.match.url}/refund-kartu`, component: StoreCashierRefund }
