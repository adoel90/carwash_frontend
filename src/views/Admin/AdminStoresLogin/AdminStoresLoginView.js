...
const AdminStoresLoginView = props => {
    
    const { credentials, handleInputChange, onLoginSubmit } = props;
                ...
                <Column md={8} sm={12}>
                    <div className="admin-login__content">
                        <div className="admin-login__heading">
                            <h4 className="heading-title">805 Carwash Store </h4>
                            <h6 className="heading-subtitle">Silahkan masukkan username Store dan password Anda untuk masuk.</h6>
                        </div>
...
export default AdminStoresLoginView;
