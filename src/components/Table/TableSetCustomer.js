...
import { Table, TableHead, TableBody, TablePagination } from '../Table';
...
class TableSetCustomer extends Component {
	constructor() {
		super();
...
export default TableSetCustomer;
