...
class CashierNewCardPaymentReceipt extends Component{
    ...
    render(){
        ...
        if(statusPrintData === 200){
            ...
            let customerName = printData.data.data.result.name;
            let cardType = printData.data.data.result.card.type.name;
            let bonusMoney = printData.data.data.result.card.type.bonus;
            let saldoNow = printData.data.data.result.balance;
...
export default CashierNewCardPaymentReceipt;