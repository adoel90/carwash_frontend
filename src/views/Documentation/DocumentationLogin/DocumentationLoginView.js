...
// import { default as AdminPanelBanner } from '../../../assets/images/lawyer-login.jpg';
import { Alert } from '../../../components/Alert';

const DocumentationLoginView = props => {
                ...
                <Column md={8} sm={12}>
                    <div className="admin-login__content">
                        <div className="admin-login__heading">
                            <h4 className="heading-title">Lawyer Web Apps</h4>
...
export default DocumentationLoginView;